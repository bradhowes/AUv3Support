...
- (void)testReadInterpolated {
  ...
  buffer.write(2.4);
  buffer.write(3.6);
  XCTAssertEqualWithAccuracy(buffer.read(1.0), 2.4, 0.001);
  XCTAssertEqualWithAccuracy(buffer.read(2.0), 1.2, 0.001);
  XCTAssertEqualWithAccuracy(buffer.read(3.0), 0.0, 0.001);
  XCTAssertEqualWithAccuracy(buffer.read(1.1), 2.28, 0.001);
  XCTAssertEqualWithAccuracy(buffer.read(1.2), 2.16, 0.001);
  XCTAssertEqualWithAccuracy(buffer.read(1.5), 1.80, 0.001);
  XCTAssertEqualWithAccuracy(buffer.read(1.8), 1.44, 0.001);
  XCTAssertEqualWithAccuracy(buffer.read(1.9), 1.32, 0.001);
}
...
- (void)testWrapping {
  ...
  buffer.write(4.8);
  buffer.write(5.0);
  XCTAssertEqualWithAccuracy(buffer.readFromOffset(0), 5.0, 0.001);
  XCTAssertEqualWithAccuracy(buffer.readFromOffset(1), 4.8, 0.001);
  XCTAssertEqualWithAccuracy(buffer.readFromOffset(2), 3.6, 0.001);
  XCTAssertEqualWithAccuracy(buffer.readFromOffset(3), 2.4, 0.001);
  XCTAssertEqualWithAccuracy(buffer.readFromOffset(4), 5.0, 0.001);
}
