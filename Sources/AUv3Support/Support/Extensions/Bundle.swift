...
public extension Bundle {
  ...
  func audioFileResource(name: String) -> AVAudioFile {
    let (filename, ext) = string?.split(separator: Character("."))
    guard let url = self.url(forResource: filename, withExtension: ext) else {
