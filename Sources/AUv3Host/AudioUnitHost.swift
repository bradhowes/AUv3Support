...
public final class AudioUnitHost {
   ...
   */
  public init(componentDescription: AudioComponentDescription, loop: SampleLoop) {
  ...
  private func notifyDelegate() {
    ...
    if let creationError = creationError {
      ...
      DispatchQueue.performOnMain { self.delegate?.connected(audioUnit: avAudioUnit, viewController: viewController) }
    }
  }
}
